...
print("--- Starting Outlines-Constrained Argumentation Scheme Inference Pipeline (Exact Prompt) ---")

# 1. Define the full 26 valid schemes using Literal to match the QT-Schemes dataset perfectly
...
# 2. Load the QT-Schemes dataset
df = pd.read_csv("qt_schemes_repo/QT-Schemes/10June2021.csv", sep=";")
print(f"Loaded QT-Schemes dataset with {len(df)} rows.")
...
# 4. Define your exact inference function with the full few-shot definitions prompt
...
Classify the following argument into one of the classes.
...
# 5. Run inference across the QT-Schemes dataset using the 'text' column
print("Running constrained inference across QT-Schemes dataset...")
schemes = []
...
output_file = "qt_inferred_schemes_full_output.csv"
