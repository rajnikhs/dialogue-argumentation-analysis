...
print("--- Starting Outlines-Constrained Argumentation Scheme Inference Pipeline (QT-Schemes) ---")
...
# 2. Load the QT-Schemes dataset (using the semicolon separator)
...
# 5. Run inference across the QT-Schemes dataset
print("Running constrained inference across QT-Schemes with few-shot prompt...")
schemes = []
